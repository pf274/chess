...
public class WebSocketTests {
    ...
    public void validMove() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        //create pawn move
        ChessPosition startingPosition = ChessTests.TestFactory.getNewPosition(2, 5);
        ChessPosition endingPosition = ChessTests.TestFactory.getNewPosition(3, 5);
        ChessMove move = ChessTests.TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveBadMove() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move rook
        ChessPosition startingPosition = ChessTests.TestFactory.getNewPosition(1, 1);
        ChessPosition endingPosition = ChessTests.TestFactory.getNewPosition(1, 5);
        ChessMove move = ChessTests.TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveWrongTurn() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move pawn
        ChessPosition startingPosition = ChessTests.TestFactory.getNewPosition(7, 5);
        ChessPosition endingPosition = ChessTests.TestFactory.getNewPosition(5, 5);
        ChessMove move = ChessTests.TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveOpponent() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move pawn
        ChessPosition startingPosition = ChessTests.TestFactory.getNewPosition(2, 5);
        ChessPosition endingPosition = ChessTests.TestFactory.getNewPosition(4, 5);
        ChessMove move = ChessTests.TestFactory.getNewMove(startingPosition, endingPosition, null);
